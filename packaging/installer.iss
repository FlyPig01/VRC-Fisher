...
chinesetrad.TaskDownloadModels=安裝後下載相容的 ONNX 模型
...
japanese.TaskDownloadModels=インストール後に互換性のある ONNX モデルをダウンロード
...
korean.TaskDownloadModels=설치 후 호환되는 ONNX 모델 다운로드
...
spanish.TaskDownloadModels=Descargar modelos ONNX compatibles después de la instalación
...
french.TaskDownloadModels=Télécharger les modèles ONNX compatibles après l'installation
...
brazilianportuguese.TaskDownloadModels=Baixar modelos ONNX compatíveis após a instalação
...
russian.TaskDownloadModels=Скачать совместимые модели ONNX после установки
...
czech.TaskDownloadModels=Po instalaci stáhnout kompatibilní modely ONNX
...
hungarian.TaskDownloadModels=Kompatibilis ONNX-modellek letöltése a telepítés után
...
ukrainian.TaskDownloadModels=Завантажити сумісні моделі ONNX після встановлення
...
thai.TaskDownloadModels=ดาวน์โหลดโมเดล ONNX ที่เข้ากันได้หลังการติดตั้ง
...
finnish.TaskDownloadModels=Lataa yhteensopivat ONNX-mallit asennuksen jälkeen
